  ...
  it("should handle error response", async () => {
    fetchMock.mockImplementation(() =>
      Promise.resolve({
        ...
        headers: new Map([["content-type", "application/json"]]),
        json: () =>
          Promise.resolve({ error: "Bad Request", code: "BAD_REQUEST" }),
      } as unknown as Response),
    );
  ...
  it("should handle wrapped response with data field", async () => {
    fetchMock.mockImplementation(() =>
      Promise.resolve({
        ...
        headers: new Map([["content-type", "application/json"]]),
        json: () =>
          Promise.resolve({ data: { nested: "value" }, code: "SUCCESS" }),
      } as unknown as Response),
    );
...
describe("remoteAction", () => {
  ...
  it("should create typed remote action caller", async () => {
    ...
    const createUser = remoteAction<CreateUserInput, CreateUserOutput>(
      "createUser",
    );
