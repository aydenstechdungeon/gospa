 ...
 */
export function createIndexedDBPersistence(config?: IndexedDBConfig): IndexedDBPersistence {
 ...
 */
export function getIndexedDBPersistence(config?: IndexedDBConfig): IndexedDBPersistence {
