...
func Page() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = components.CodeBlock(`import { navigate, back, forward, go } from '/_gospa/runtime.js';
...
go(3);               // Go forward 3 pages`, "typescript", " navigation.ts").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = components.CodeBlock(`import { prefetch, prefetchLinks } from '/_gospa/runtime.js';
...
prefetchLinks('a[data-prefetch]');`, "typescript", " prefetch.ts").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = components.CodeBlock(`import { invalidate, invalidateTag, invalidateKey } from '/_gospa/runtime.js';
...
await invalidateKey('path:/dashboard');`, "typescript", " invalidate.ts").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = components.CodeBlock(`import { createNavigationState, rune } from '/_gospa/runtime.js';
...
const state = nav.getState();`, "typescript", " nav-state.ts").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = components.CodeBlock(`import { onBeforeNavigate, onAfterNavigate } from '/_gospa/runtime.js';
...
unsubAfter();`, "typescript", " lifecycle.ts").Render(ctx, templ_7745c5c3_Buffer)
  ...
  // Re-run third-party initializers here
		...
		templ_7745c5c3_Err = components.CodeBlock(`import { on, off, delegate, debounce, throttle } from '/_gospa/runtime.js';
...
window.addEventListener('scroll', throttledScroll);`, "typescript", " events.ts").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = components.CodeBlock(`import { on } from '/_gospa/runtime.js';
...
on(modal, 'click:once:prevent', (e) => {
  closeModal();
		...
		templ_7745c5c3_Err = components.CodeBlock(`import { onKey, keys } from '/_gospa/runtime.js';
...
onKey(document, ['ArrowUp', 'ArrowDown'], (e) => {
  navigateList(e.key === 'ArrowUp' ? -1 : 1);
		...
		templ_7745c5c3_Err = components.CodeBlock(`import { initNavigation, destroyNavigation } from '/_gospa/runtime.js';
...
destroyNavigation();`, "typescript", " init.ts").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = components.CodeBlock(`// Example: Disable progress bar on specific links
<a href="/slow-page" data-gospa-progress="false">Slow Page</a>

// Example: Disable prefetching on a link
<a href="/large-page" data-gospa-prefetch="false">Large Page</a>

// Example: Programmatic configuration
initNavigation({
  progressBar: { enabled: false },
  speculativePrefetching: false,
  viewTransitions: false
});`, "html", " navigation-options.html").Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
