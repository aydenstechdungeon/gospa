...
unsubscribe();`,
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<div class=\"overflow-x-auto\"><table class=\"w-full border-collapse\"><thead><tr class=\"border-b border-[var(--border)]\"><th class=\"text-left py-3 px-4 font-semibold\">Method</th><th class=\"text-left py-3 px-4 font-semibold\">Description</th></tr></thead> <tbody class=\"text-[var(--text-secondary)]\"><tr class=\"border-b border-[var(--border)]\"><td class=\"py-3 px-4\"><code class=\"text-[var(--accent-primary)]\">get()</code></td><td class=\"py-3 px-4\">Get value (tracks dependencies)</td></tr><tr class=\"border-b border-[var(--border)]\"><td class=\"py-3 px-4\"><code class=\"text-[var(--accent-primary)]\">set(value)</code></td><td class=\"py-3 px-4\">Set new value</td></tr><tr class=\"border-b border-[var(--border)]\"><td class=\"py-3 px-4\"><code class=\"text-[var(--accent-primary)]\">update(fn)</code></td><td class=\"py-3 px-4\">Update using function</td></tr><tr class=\"border-b border-[var(--border)]\"><td class=\"py-3 px-4\"><code class=\"text-[var(--accent-primary)]\">subscribe(fn)</code></td><td class=\"py-3 px-4\">Subscribe to changes</td></tr><tr class=\"border-b border-[var(--border)]\"><td class=\"py-3 px-4\"><code class=\"text-[var(--accent-primary)]\">peek()</code></td><td class=\"py-3 px-4\">Get value without tracking</td></tr><tr class=\"border-b border-[var(--border)]\"><td class=\"py-3 px-4\"><code class=\"text-[var(--accent-primary)]\">ID()</code></td><td class=\"py-3 px-4\">Unique internal identifier</td></tr></tbody></table></div></section><section class=\"space-y-6\"><h2 class=\"text-2xl font-bold\" id=\"derived\">Derived</h2><p class=\"text-[var(--text-secondary)]\">Computed reactive value that recalculates when dependencies change.</p>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = components.DualCodeBlock(
...
states.clear();`, "typescript", " statemap.ts").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = components.CodeBlock(`// Create with factory or constructor
const userResource = resourceReactive(async () => {
...
userResource.reset();`, "typescript", " resource.ts").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "</section><section class=\"space-y-6\"><h2 class=\"text-2xl font-bold\" id=\"utilities\">Utility Functions</h2>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
inspect(count).with((type, value) => {
  if (type === 'update') console.log('Updated:', value);
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "</section><section class=\"space-y-6\"><h2 class=\"text-2xl font-bold\" id=\"init\">Initialization</h2>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
