...
HydrationTimeout: 2000,   // Force hydrate after 2 seconds`, "go", "main.go").Render(ctx, templ_7745c5c3_Buffer)
    ...
    SimpleRuntime: false,  // Full sanitization for dev
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 8, "<h3 class=\"text-xl font-semibold text-[var(--text-primary)] mt-6\">Production</h3>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = components.CodeBlock(`app := gospa.New(gospa.Config{
    ...
    WSHeartbeat:     30 * time.Second,
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 9, "<h3 class=\"text-xl font-semibold text-[var(--text-primary)] mt-6\">High-Performance</h3>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = components.CodeBlock(`app := gospa.New(gospa.Config{
    ...
    HydrationMode:   "lazy",
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "</section><section class=\"space-y-4\"><h2 class=\"text-2xl font-semibold text-[var(--text-primary)]\">Complete Example</h2>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
