...
safeHTML := sanitizeHTML(userInput)`, "go", "sanitize.go").Render(ctx, templ_7745c5c3_Buffer)
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "<h3 class=\"text-xl font-semibold text-[var(--text-primary)] mt-6\">Client-Side Custom Sanitizer</h3><p class=\"text-[var(--text-secondary)]\">You can provide a custom sanitizer function in the runtime config:</p>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
app := gospa.New(gospa.Config{
    ...
    SimpleRuntime: false,  // Switch to full runtime
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "<p class=\"text-[var(--text-secondary)] mt-2\">No other changes required. The full runtime is a drop-in replacement.</p></section></div>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
