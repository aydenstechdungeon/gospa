...
func Page() templ.Component {
  ...
  tailwind:
    enabled: true
    config: tailwind.config.js  # Optional: legacy config file`, "yaml", "gospa.yaml").Render(ctx, templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</section><section class=\"space-y-6\"><h2 class=\"text-2xl font-bold border-b border-[var(--border)] pb-2\">CSS-First Configuration</h2><p class=\"text-[var(--text-secondary)] mb-4\">Tailwind v4 uses CSS-first configuration with the @@theme directive:</p>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "</div></section><section class=\"space-y-6\"><h2 class=\"text-2xl font-bold border-b border-[var(--border)] pb-2\">Usage Example</h2>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
...
func featureCard(title string, description string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `routes/docs/plugins/tailwind/page.templ`, Line: 85, Col: 36}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `routes/docs/plugins/tailwind/page.templ`, Line: 86, Col: 59}
		}
