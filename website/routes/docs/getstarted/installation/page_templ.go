...
func Page() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "</section><section><h2 id=\"verify-installation\" class=\"text-2xl font-bold mb-4\">Verify Installation</h2><p class=\"text-[var(--text-secondary)] mb-4\">Check if the CLI is correctly installed:</p>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
